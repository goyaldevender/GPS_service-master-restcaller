...
public class POST_RestCall extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_post_rest_call);
...
//            new SendRequest(view).execute(new URL("http://posttestserver.com/post.php")); // .execute() method is used to start the background task.
            ...
            // Using 10.0.2.2 instead of default 127.0.0.1
            new SendRequest(view).execute(new URL("http://10.0.2.2:8080/GeoLocator/webapi/message/create")); // .execute() method is used to start the background task.
